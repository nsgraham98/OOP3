...
/**
 * Title: Package of File Input and Output Classes Description: Package that
 * contains classes to handle opening file input and output operations.
 * Copyright: Copyright (c) 2003 Company: SAIT
 * 
 * @author Dave Watson
 * @version 1.0
 */
...
public class FileOutput
{
	...
	/**
	 * User defined constructor to open an output file given a File Object as an
	 * input.
	 *
	...
	/**
	 * User defined constructor to open an output file given the file name as an
	 * input.
	 *
	...
	/**
	 * User defined constructor to open an output file in append mode given the file
	 * name and a boolean value as inputs.
	 *
	 * @param fileName - name of file to open
	...
	/**
	 * User defined constructor to open an output file in append mode given a File
	 * Object and a boolean value as inputs.
	 *
	 * @param file   - File Object to open
	 * @param append - boolean true to open in append mode
	 */
